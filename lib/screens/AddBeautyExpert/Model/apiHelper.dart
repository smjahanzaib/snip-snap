...
import 'package:SnipSnap/screens/AddBeautyExpert/Model/apiResult.dart';
import 'package:SnipSnap/screens/AddBeautyExpert/Model/appointmentHistoryModel.dart';
import 'package:SnipSnap/screens/AddBeautyExpert/Model/bookingConfirmModel.dart';
import 'package:SnipSnap/screens/AddBeautyExpert/Model/bookingDetailModel.dart';
import 'package:SnipSnap/screens/AddBeautyExpert/Model/couponModel.dart';
...
import 'package:SnipSnap/screens/AddBeautyExpert/Model/faqModel.dart';
import 'package:SnipSnap/screens/AddBeautyExpert/Model/galleryModel.dart';
import 'package:SnipSnap/screens/AddBeautyExpert/Model/global.dart' as global;
import 'package:SnipSnap/screens/AddBeautyExpert/Model/homePageModel.dart';
import 'package:SnipSnap/screens/AddBeautyExpert/Model/myWalletModel.dart';
import 'package:SnipSnap/screens/AddBeautyExpert/Model/notificationModel.dart';
import 'package:SnipSnap/screens/AddBeautyExpert/Model/partnerUserModel.dart';
import 'package:SnipSnap/screens/AddBeautyExpert/Model/privacyAndPolicyModel.dart';
import 'package:SnipSnap/screens/AddBeautyExpert/Model/productModel.dart';
import 'package:SnipSnap/screens/AddBeautyExpert/Model/productOrderModel.dart';
import 'package:SnipSnap/screens/AddBeautyExpert/Model/reviewModel.dart';
import 'package:SnipSnap/screens/AddBeautyExpert/Model/serviceModel.dart';
import 'package:SnipSnap/screens/AddBeautyExpert/Model/serviceVariantModel.dart';
import 'package:SnipSnap/screens/AddBeautyExpert/Model/userRequestModel.dart';
...
class APIHelper {
      ...
      if (response.statusCode == 200) {
        if (json.decode(response.body)["data"] != null) {
          recordList = List<AppointmentHistory>.from((json
                  ...
                  .map((x) =>
                      AppointmentHistory.fromJson(x as Map<String, dynamic>))
              as Iterable<dynamic>));
        } else {
          recordList = null;
        }
      ...
      if (response.statusCode == 200) {
        if (json.decode(response.body)["data"] != null) {
          recordList = List<Coupon>.from((json
                  .decode(response.body)["data"]
                  .map((x) => Coupon.fromJson(x as Map<String, dynamic>))
              as Iterable<dynamic>));
        } else {
          recordList = null;
        }
  ...
  Future<dynamic> getFaqs() async {
    try {
      ...
      if (response.statusCode == 200) {
        if (json.decode(response.body)["data"] != null) {
          recordList = List<Faqs>.from((json
                  .decode(response.body)["data"]
                  .map((x) => Faqs.fromJson(x as Map<String, dynamic>))
              as Iterable<dynamic>));
        } else {
          recordList = null;
        }
