...
class FormValidator {
  ...
  static FormFieldValidator<String> isMinLength({int length, String errorMessage}) {
    return (String value) {
  ...
  static FormFieldValidator<String> isMaxLength({int length, String errorMessage}) {
    return (String value) {
      return value.length > length ? errorMessage : null;
    };
  }
  ...
  static FormFieldValidator<String> matchesRegex({String regex, String errorMessage}) {
    return (String value) {
  ...
  /// ```
  ///
  static FormFieldValidator<String> validators(List<FormFieldValidator<String>> validators) {
    return (String value) {
