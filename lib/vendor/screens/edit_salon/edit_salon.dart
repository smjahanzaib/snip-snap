...
class EditSalonScreen extends StatefulWidget {
  const EditSalonScreen({Key key}) : super(key: key);

  @override
  _EditSalonScreenState createState() {
    return _EditSalonScreenState();
  }
}
...
class _EditSalonScreenState extends State<EditSalonScreen> {
  ...
  void initState() {
    ...
    _textNameController.text = "Lavish Men's Salon";
    _descriptionController.text = 'Best salon in town';
    _textPhoneController.text = '03349783461';
    _textWebsiteController.text = 'http://www.lavishsalon.com';
    _textAddressController.text = 'Gulshan-e-Iqbal block 3, karachi';
    _textZIPController.text = '75567';
    _textCityController.text = 'Karachi';
                    ...
                    ? Container(
                        decoration: BoxDecoration(
                          ...
                          image: const DecorationImage(
                            image: AssetImage(
                                'assets/images/data/locations/barber-shop-2.jpg'),
                            fit: BoxFit.cover,
                          ),
                        ),
                      )
          ...
          children: <Widget>[
            Expanded(
              child: ListView(
                ...
                children: <Widget>[
                  _profilePicture(),
                  const FormLabel(text: 'Salon Name'),
                  ThemeTextInput(
                    key: keyNameInput,
                  ...
                  const FormLabel(text: 'Salon About Us'),
                  ThemeTextInput(
                  ...
                  const FormLabel(text: 'Salon Website'),
                  ThemeTextInput(
                    focusNode: _focusPhone,
                    textInputAction: TextInputAction.next,
                    onSubmitted: (String text) {
